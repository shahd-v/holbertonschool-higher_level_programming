#!/usr/bin/python3
"""Define a Rectangle class with a customizable print symbol."""


class Rectangle:
    """Represent a rectangle that renders with a class print symbol."""
    ...
    def __str__(self):
        """Return a drawing of the rectangle using the print symbol."""
        if self.__width == 0 or self.__height == 0:
            return ""
